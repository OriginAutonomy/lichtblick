...
export const appSettings = {
  ...
  dark: "Dark",
  debugModeDescription: "Enable panels and features for debugging Eagle",
  ...
  syncLichtblickInstances: "Sync Eagle instances",
  syncLichtblickInstancesDescription:
    "Activates the button in the right lower corner of the application to sync Eagle instances opened.",
